      ...
      <div className="relative flex-shrink-0" style={{ height: "64px", background: "#11141b" }}>
        ...
        <div className="absolute right-[16px] top-[16px] flex items-center gap-[8px]">
          ...
          <button onClick={onEdit} data-testid="button-edit-agent"
            ...
            <span className="[font-family:'Gilroy',sans-serif] text-[#6c779d] text-[12px] leading-[16px] whitespace-nowrap">Edit</span>
          </button>
          {/* Stop / Start */}
          <button data-testid="button-stop-agent" onClick={onToggle}
            ...
            <span className="[font-family:'Gilroy',sans-serif] text-[#d20344] text-[12px] leading-[16px] whitespace-nowrap">
              {isActive ? "Stop" : "Start"}
            </span>
          </button>
          {/* Delete */}
          <button data-testid="button-delete-agent" onClick={() => setShowConfirm(true)}
            ...
            <span className="[font-family:'Gilroy',sans-serif] font-semibold text-[#d20344] text-[12px] leading-[16px] whitespace-nowrap">Delete</span>
          </button>
        </div>
      </div>
...
const AgentHeaderCard = ({ agent, agentType, agentId }: {
  ...
  <div className="rounded-[16px] overflow-hidden flex flex-col gap-[8px] p-[16px]" style={{ background: "#0a0c10" }}>
    <div className="flex gap-[8px] items-center w-full">
      ...
      <div className="flex flex-1 min-w-0 flex-col gap-[4px]">
        <div className="flex items-center gap-[4px]">
          <span className="[font-family:'Gilroy',sans-serif] text-white text-[16px] leading-[20px] whitespace-nowrap">{agent.name}</span>
          <div className="flex items-center justify-center px-[8px] py-[3px] rounded-[22px] flex-shrink-0"
            ...
            <span className="[font-family:'Gilroy',sans-serif] text-[#6c779d] text-[11px] leading-[14px] capitalize">{agentType}</span>
          </div>
        </div>
        <div className="flex items-center gap-[8px] flex-wrap">
          <span className="[font-family:'Gilroy',sans-serif] text-[#6c779d] text-[14px] leading-[20px] whitespace-nowrap">
    ...
    <p className="[font-family:'Gilroy',sans-serif] text-[#a8b9f4] text-[14px] leading-[20px]">{agent.description}</p>
  </div>
);
...
const StatCard = ({ label, value, sup, color }: { label: string; value: string; sup?: string; color?: string }) => (
  <div className="rounded-[16px] p-[16px] flex flex-col gap-[8px] flex-1 min-w-0" style={{ background: "#0a0c10" }}>
    <span className="[font-family:'Gilroy',sans-serif] text-[#414965] text-[13px] leading-[14px] whitespace-nowrap">{label}</span>
    <p style={{ color: color ?? "#a8b9f4", fontSize: 0, lineHeight: 0 }}>
      <span className="[font-family:'Gilroy',sans-serif] text-[20px] leading-[24px]">{value}</span>
      {sup && <span className="[font-family:'Gilroy',sans-serif] text-[16px] leading-[24px]">{sup}</span>}
    </p>
  </div>
);
  ...
  <div className="rounded-[16px] overflow-hidden" style={{ background: "#0a0c10" }}>
    <div className="px-[16px] py-[12px] flex items-center justify-between" style={{ borderBottom: "1px solid #1d2132" }}>
      <div className="flex items-center gap-[8px]">
        <span className="[font-family:'Gilroy',sans-serif] text-[#a8b9f4] text-[16px] leading-[20px]">Policies</span>
        <Dot />
        <span className="[font-family:'Gilroy',sans-serif] text-[#6c779d] text-[13px] leading-[20px]">V4</span>
        <Dot />
        <span className="[font-family:'Gilroy',sans-serif] text-[#6c779d] text-[13px] leading-[20px]">edited on-chain 42 days ago</span>
      </div>
      {onEdit && (
        <button onClick={onEdit}
          ...
          <span className="[font-family:'Gilroy',sans-serif] text-[#6c779d] text-[12px] leading-[16px]">Edit</span>
        </button>
      )}
    </div>
        ...
        <div key={ri} className="grid gap-[8px]" style={{ gridTemplateColumns: `repeat(${row.length}, 1fr)` }}>
          {row.map((cell, ci) => (
            <div key={ci} className="flex flex-col gap-[4px] px-[12px] py-[10px] rounded-[8px]"
              ...
              <span className="[font-family:'Gilroy',sans-serif] text-[#6c779d] text-[11px] leading-[14px]">{cell.label}</span>
              <span className="[font-family:'Gilroy',sans-serif] text-white text-[14px] leading-[20px]">{cell.value}</span>
            </div>
          ))}
        </div>
      ))}
  ...
  return (
    <div className="rounded-[16px] overflow-hidden" style={{ background: "#0a0c10" }}>
      <div className="px-[16px] py-[12px] flex items-center justify-between"
        ...
        <span className="[font-family:'Gilroy',sans-serif] text-[#a8b9f4] text-[16px] leading-[20px]">Schema</span>
        <div className="flex items-center gap-[8px]">
          <button className="flex items-center gap-[4px] px-[12px] py-[7px] rounded-[100px] hover:opacity-80"
            style={{ background: "#222737" }}>
            <span className="[font-family:'Gilroy',sans-serif] text-[#6c779d] text-[12px] leading-[16px]">View Raw →</span>
          </button>
        ...
        <div>
          {pairs.map(([left, right], i) => (
            <div key={i} className="grid grid-cols-4 gap-[8px] px-[16px] py-[10px]"
              ...
              <code className="[font-family:'JetBrains_Mono',sans-serif] text-[#414965] text-[11px] truncate">{left.k}</code>
              <span className="[font-family:'JetBrains_Mono',sans-serif] text-[#6c779d] text-[11px] truncate col-span-1">{left.v}</span>
              <code className="[font-family:'JetBrains_Mono',sans-serif] text-[#414965] text-[11px] truncate">{right?.k ?? ""}</code>
              <span className="[font-family:'JetBrains_Mono',sans-serif] text-[#6c779d] text-[11px] truncate">{right?.v ?? ""}</span>
            </div>
          ))}
        </div>
      )}
...
const TxSectionTitle = ({ title }: { title: string }) => (
  <div className="px-[16px] h-[48px] flex items-center flex-shrink-0" style={{ borderBottom: "1px solid #1d2132" }}>
    <span className="[font-family:'Gilroy',sans-serif] text-[#a8b9f4] text-[16px] leading-[24px]">{title}</span>
  </div>
);

const TxHeaderCell = ({ children, right }: { children: string; right?: boolean }) => (
  <span className={`[font-family:'Gilroy',sans-serif] text-[#414965] text-[11px] leading-[14px] ${right ? "text-right" : ""}`}>{children}</span>
);

const TxCell = ({ children, mono, muted, right }: { children: React.ReactNode; mono?: boolean; muted?: boolean; right?: boolean }) => (
  <span className={`${mono ? "[font-family:'JetBrains_Mono',sans-serif]" : "[font-family:'Gilroy',sans-serif]"} text-[${muted ? "#6c779d" : "#a8b9f4"}] text-[12px] leading-[16px] ${right ? "text-right" : ""} truncate`}
...
const StatusBadge = ({ label, color, bg }: { label: string; color: string; bg: string }) => (
  <div className="flex items-center justify-center px-[8px] py-[3px] rounded-[22px] w-fit"
    style={{ background: bg }}>
    <span className="[font-family:'Gilroy',sans-serif] text-[11px] leading-[14px] whitespace-nowrap" style={{ color }}>{label}</span>
  </div>
);
...
const RailBadge = ({ rail }: { rail: string }) => {
  ...
  return (
    <div className="flex items-center justify-center px-[8px] py-[3px] rounded-[22px] w-fit"
      ...
      <span className="[font-family:'Gilroy',sans-serif] text-[11px] leading-[14px] whitespace-nowrap" style={{ color: c.color }}>{rail}</span>
    </div>
  );
};
...
const TradingCrosshair = (chartProps: any) => {
  ...
  return (
    <g>
      ...
      <text x={pillX + pillW / 2} y={pillY + pillH / 2 + 3.5} textAnchor="middle" fill="#ff9500" fontSize={10} fontFamily="'Gilroy', sans-serif" fontWeight="600">{formatted}</text>
    </g>
  );
};
          ...
          <div className="grid grid-cols-2 gap-[16px]">
            ...
            <div className="rounded-[16px] overflow-hidden flex flex-col" style={{ background: "#0a0c10" }}>
              <div className="flex items-center justify-between px-[16px] py-[12px] h-[48px] flex-shrink-0" style={{ borderBottom: "1px solid #1d2132" }}>
                <span className="[font-family:'Gilroy',sans-serif] text-[#a8b9f4] text-[16px] leading-[24px]">Equity Curve</span>
                <div className="flex gap-[2px] p-[2px] rounded-[400px]" style={{ background: "#06070a" }}>
                  {TIME_TABS.map((tab) => (
                    <button key={tab} onClick={() => setChartTab(tab)}
                      className="px-[8px] py-[4px] text-[12px] [font-family:'Gilroy',sans-serif] transition-all rounded-[100px] leading-[16px]"
              ...
              <div className="relative flex-1" style={{ minHeight: "284px" }}>
                ...
                <div className="absolute right-[8px] top-0 bottom-0 flex flex-col justify-between pointer-events-none" style={{ paddingTop: "8px", paddingBottom: "4px" }}>
                  {chartSet.yLabels.map((lbl) => (
                    <span key={lbl} className="[font-family:'Gilroy',sans-serif] text-[10px] leading-[14px] text-right" style={{ color: "#6c779d" }}>{lbl}</span>
                  ))}
                </div>
              </div>
              <div className="flex items-center justify-between px-[8px] py-[4px]" style={{ borderTop: "1px solid #1d2132" }}>
                {chartSet.xLabels.map((lbl, i) => (
                  <span key={i} className="[font-family:'Gilroy',sans-serif] text-[10px] leading-[14px]" style={{ color: "#6c779d" }}>{lbl}</span>
                ))}
              </div>
            </div>
            ...
            <div className="rounded-[16px] overflow-hidden flex flex-col" style={{ background: "#0a0c10" }}>
              <div className="px-[16px] py-[12px] h-[48px] flex items-center" style={{ borderBottom: "1px solid #1d2132" }}>
                <span className="[font-family:'Gilroy',sans-serif] text-[#a8b9f4] text-[16px] leading-[24px]">Open Positions</span>
              </div>
                  ...
                  <div key={i}>
                    <div className="flex items-start justify-between">
                      <div className="flex flex-col gap-[4px]">
                        <span className="[font-family:'Gilroy',sans-serif] text-[#a8b9f4] text-[14px] leading-[20px]">{pos.market}</span>
                        <div className="flex items-center gap-[4px]">
                          <span className="[font-family:'Gilroy',sans-serif] text-[#6c779d] text-[13px] leading-[16px]">{pos.dir}</span>
                          <Dot />
                          <span className="[font-family:'Gilroy',sans-serif] text-[#6c779d] text-[13px] leading-[16px]">{pos.lev}</span>
                        </div>
                      </div>
                      <div className="flex flex-col items-end gap-[2px]">
                        <span className="[font-family:'JetBrains_Mono',sans-serif] text-[#a8b9f4] text-[14px] leading-[20px]">{pos.value}</span>
          ...
          <div className="grid grid-cols-2 gap-[16px]">
            <div className="rounded-[16px] overflow-hidden flex flex-col" style={{ background: "#0a0c10" }}>
              <div className="px-[16px] h-[48px] flex items-center" style={{ borderBottom: "1px solid #1d2132" }}>
                <span className="[font-family:'Gilroy',sans-serif] text-[#a8b9f4] text-[16px] leading-[24px]">Outstanding Loans</span>
              </div>
              <div className="flex flex-col px-[16px] py-[12px] gap-[12px]">
                {OUTSTANDING_LOANS.map((loan, i) => (
                  <div key={i} className="flex items-center gap-[8px]">
                    <div className="flex flex-col flex-1 min-w-0">
                      <span className="[font-family:'Gilroy',sans-serif] text-[#a8b9f4] text-[13px] leading-[18px]">{loan.addr}</span>
                      <span className="[font-family:'Gilroy',sans-serif] text-[#6c779d] text-[12px] leading-[16px]">{loan.protocol} · {loan.collateral}</span>
                    </div>
                    <div className="flex items-center justify-center px-[8px] py-[3px] rounded-[22px] flex-shrink-0" style={{ background: ltvBg(loan.ltv) }}>
                      <span className="[font-family:'Gilroy',sans-serif] text-[11px] leading-[14px]" style={{ color: ltvColor(loan.ltv) }}>LTV {loan.ltv}%</span>
                    </div>
                    <div className="flex flex-col items-end flex-shrink-0">
                      <span className="[font-family:'Gilroy',sans-serif] text-[#a8b9f4] text-[13px] leading-[18px]">{loan.amount}</span>
                      <span className="[font-family:'Gilroy',sans-serif] text-[12px] leading-[16px]" style={{ color: loan.pos ? "#42bf23" : "#d20344" }}>{loan.pct}</span>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="rounded-[16px] overflow-hidden flex flex-col" style={{ background: "#0a0c10" }}>
              <div className="px-[16px] h-[48px] flex items-center" style={{ borderBottom: "1px solid #1d2132" }}>
                <span className="[font-family:'Gilroy',sans-serif] text-[#a8b9f4] text-[16px] leading-[24px]">LTV Distribution</span>
              </div>
              <div className="flex flex-col px-[16px] py-[12px] gap-[16px]">
                {LTV_DISTRIBUTION.map((band) => (
                  <div key={band.label} className="flex flex-col gap-[6px]">
                    <div className="flex items-center justify-between">
                      <span className="[font-family:'Gilroy',sans-serif] text-[#6c779d] text-[13px] leading-[16px]">{band.label}</span>
                      <span className="[font-family:'Gilroy',sans-serif] text-[#a8b9f4] text-[13px] leading-[16px]">{band.loans} Loans</span>
                    </div>
                ...
                <p className="[font-family:'Gilroy',sans-serif] text-[#414965] text-[12px] leading-[16px]">
    ...
    <div className="flex flex-col h-full bg-[#11141b] rounded-[16px] border border-solid border-[#1d2132] overflow-hidden">
      ...
      <ScrollArea className="flex-1">
        <div className="flex flex-col gap-[16px] p-[16px] pb-8">
          ...
          <div className="rounded-[16px] overflow-hidden" style={{ background: "#0a0c10" }}>
            <div className="px-[16px] h-[48px] flex items-center" style={{ borderBottom: "1px solid #1d2132" }}>
              <span className="[font-family:'Gilroy',sans-serif] text-[#a8b9f4] text-[16px] leading-[24px]">Current Allocations</span>
            </div>
            <div className="flex flex-col px-[16px] py-[12px] gap-[16px]">
              {YIELD_ALLOCATIONS.map((alloc, i) => (
                <div key={i} className="flex flex-col gap-[6px]">
                  <div className="flex items-center justify-between">
                    <span className="[font-family:'Gilroy',sans-serif] text-[#a8b9f4] text-[14px] leading-[20px]">{alloc.protocol}</span>
                    <div className="flex items-center gap-[16px]">
                      <span className="[font-family:'Gilroy',sans-serif] text-[#6c779d] text-[13px] leading-[16px]">APY {alloc.apy}</span>
                      <span className="[font-family:'JetBrains_Mono',sans-serif] text-[#a8b9f4] text-[13px] leading-[16px]">{alloc.amount}</span>
                      <span className="[font-family:'Gilroy',sans-serif] text-[#6c779d] text-[13px] leading-[16px] w-[32px] text-right">{alloc.pct}%</span>
                    </div>
                  </div>
                  <div className="h-[6px] rounded-full w-full" style={{ background: "#1d2132" }}>
    ...
    <div className="flex flex-col h-full bg-[#11141b] rounded-[16px] border border-solid border-[#1d2132] overflow-hidden">
      ...
      <ScrollArea className="flex-1">
        <div className="flex flex-col gap-[16px] p-[16px] pb-8">
          ...
          <div className="rounded-[16px] overflow-hidden" style={{ background: "#0a0c10" }}>
            <div className="px-[16px] h-[48px] flex items-center" style={{ borderBottom: "1px solid #1d2132" }}>
              <span className="[font-family:'Gilroy',sans-serif] text-[#a8b9f4] text-[16px] leading-[24px]">Allowlisted Recipients</span>
            </div>
            <div className="px-[16px]">
              <div className="grid gap-[8px] py-[10px]"
              ...
              {ALLOWLISTED_RECIPIENTS.map((r, i) => (
                <div key={i} className="grid gap-[8px] py-[10px]" style={{ gridTemplateColumns: "1fr 70px 100px 90px 80px", borderTop: "1px solid #0d1018" }}>
                  <div className="flex flex-col">
                    <span className="[font-family:'Gilroy',sans-serif] text-[#a8b9f4] text-[12px] leading-[16px]">{r.name}</span>
                    <span className="[font-family:'Gilroy',sans-serif] text-[#6c779d] text-[11px] leading-[14px]">{r.sub}</span>
                  </div>
    ...
    <div className="flex flex-col h-full bg-[#11141b] rounded-[16px] border border-solid border-[#1d2132] overflow-hidden">
      ...
      <ScrollArea className="flex-1">
        <div className="flex flex-col gap-[16px] p-[16px] pb-8">
          ...
          <div className="rounded-[16px] overflow-hidden" style={{ background: "#0a0c10" }}>
            <div className="px-[16px] h-[48px] flex items-center" style={{ borderBottom: "1px solid #1d2132" }}>
              <span className="[font-family:'Gilroy',sans-serif] text-[#a8b9f4] text-[16px] leading-[24px]">Alert Rules</span>
            </div>
            <div className="px-[16px]">
              <div className="grid gap-[8px] py-[10px]"
    ...
    <div className="flex flex-col h-full bg-[#11141b] rounded-[16px] border border-solid border-[#1d2132] overflow-hidden">
      ...
      <ScrollArea className="flex-1">
        <div className="flex flex-col gap-[16px] p-[16px] pb-8">
          ...
          <div className="rounded-[16px] overflow-hidden" style={{ background: "#0a0c10" }}>
            <div className="px-[16px] h-[48px] flex items-center" style={{ borderBottom: "1px solid #1d2132" }}>
              <span className="[font-family:'Gilroy',sans-serif] text-[#a8b9f4] text-[16px] leading-[24px]">Objective</span>
            </div>
            <div className="flex gap-[8px] p-[16px]">
              <div className="flex flex-col gap-[4px] flex-1 px-[12px] py-[10px] rounded-[8px]" style={{ background: "#11141b" }}>
                <span className="[font-family:'Gilroy',sans-serif] text-[#6c779d] text-[11px] leading-[14px]">Target Outcome</span>
                <span className="[font-family:'Gilroy',sans-serif] text-white text-[14px] leading-[20px]">
              ...
              <div className="flex flex-col gap-[4px] w-[160px] px-[12px] py-[10px] rounded-[8px]" style={{ background: "#11141b" }}>
                <span className="[font-family:'Gilroy',sans-serif] text-[#6c779d] text-[11px] leading-[14px]">Complexity</span>
                <span className="[font-family:'Gilroy',sans-serif] text-white text-[14px] leading-[20px]">
                  {complexityLevel}
                </span>
              </div>
          ...
          <div className="rounded-[16px] overflow-hidden" style={{ background: "#0a0c10" }}>
            ...
            <div className="flex flex-col gap-[16px] p-[16px]">
              ...
              <div className="flex flex-col gap-[8px]">
                <span className="[font-family:'Gilroy',sans-serif] text-[#414965] text-[11px] leading-[14px] uppercase tracking-widest">Tools Allowed</span>
                <div className="grid grid-cols-3 gap-[8px]">
                  {toolsGrid.map((tool, i) => (
                    <div key={i} className="flex items-center justify-between px-[12px] py-[10px] rounded-[8px]" style={{ background: "#11141b" }}>
                      <span className="[font-family:'Gilroy',sans-serif] text-[#a8b9f4] text-[13px] leading-[16px]">{tool.name}</span>
              ...
              {/* Numeric Limits */}
              <div className="flex flex-col gap-[8px]">
                <span className="[font-family:'Gilroy',sans-serif] text-[#414965] text-[11px] leading-[14px] uppercase tracking-widest">Numeric Limits</span>
                <div className="grid grid-cols-3 gap-[8px]">
                  {[
                    ...
                    <div key={c.label} className="flex flex-col gap-[4px] px-[12px] py-[10px] rounded-[8px]" style={{ background: "#11141b" }}>
                      <span className="[font-family:'Gilroy',sans-serif] text-[#6c779d] text-[11px] leading-[14px]">{c.label}</span>
                      <span className="[font-family:'Gilroy',sans-serif] text-white text-[14px] leading-[20px]">{c.value}</span>
                    </div>
                  ))}
                </div>
                <div className="grid grid-cols-3 gap-[8px]">
                  <div className="flex flex-col gap-[4px] px-[12px] py-[10px] rounded-[8px]" style={{ background: "#11141b" }}>
                    <span className="[font-family:'Gilroy',sans-serif] text-[#6c779d] text-[11px] leading-[14px]">Execution Window</span>
                    <span className="[font-family:'Gilroy',sans-serif] text-white text-[14px] leading-[20px]">{execWindow}</span>
                  </div>
                  <div className="flex flex-col gap-[4px] px-[12px] py-[10px] rounded-[8px]" style={{ background: "#11141b" }}>
                    <span className="[font-family:'Gilroy',sans-serif] text-[#6c779d] text-[11px] leading-[14px]">Runtime</span>
                    <span className="[font-family:'Gilroy',sans-serif] text-white text-[14px] leading-[20px]">{runtimeLabel}</span>
                  </div>
                  <div className="flex flex-col gap-[4px] px-[12px] py-[10px] rounded-[8px]" style={{ background: "#11141b" }}>
                    <span className="[font-family:'Gilroy',sans-serif] text-[#6c779d] text-[11px] leading-[14px]">Source Type</span>
                    <span className="[font-family:'Gilroy',sans-serif] text-white text-[14px] leading-[20px]">{sourceType}</span>
                  </div>
                </div>
              </div>
              {/* Safety Circuit Breakers */}
              <div className="flex flex-col gap-[8px]">
                <span className="[font-family:'Gilroy',sans-serif] text-[#414965] text-[11px] leading-[14px] uppercase tracking-widest">Safety Circuit Breakers</span>
                <div className="grid grid-cols-3 gap-[8px]">
                  {[
  ...
  if (!agent) {
    return (
      <div className="flex flex-col items-center justify-center h-full gap-4 bg-[#11141b] rounded-[16px] border border-[#1d2132]">
        ...
        <p className="[font-family:'Gilroy',sans-serif] text-[#414965] text-[14px]">Agent not found</p>
        <button onClick={() => navigate("/agents")}
          className="px-4 py-2 rounded-full text-sm hover:opacity-80"
          style={{ background: "#4a2300", color: "#ff9500", fontFamily: "'Gilroy', sans-serif" }}>
          Back to Agents
        </button>
      </div>
    );
