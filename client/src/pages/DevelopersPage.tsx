      ...
      <div className="bg-[#06070a] border border-[#1d2132] flex gap-[12px] items-center p-[12px] rounded-[12px] w-full">
        ...
        >
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" className="shrink-0">
            <rect x="5.5" y="5.5" width="7.5" height="7.5" rx="1.5" stroke="#6c779d" strokeWidth="2.2" />
            <path d="M10.5 5.5V4.2C10.5 3.54 9.96 3 9.3 3H4.2C3.54 3 3 3.54 3 4.2V9.3C3 9.96 3.54 10.5 4.2 10.5H5.5" stroke="#6c779d" strokeWidth="2.2" strokeLinecap="round" />
          </svg>
          {copied ? "Copied" : "Copy"}
        </button>
      </div>
