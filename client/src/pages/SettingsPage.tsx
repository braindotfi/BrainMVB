...
const SectionLabel = ({ children }: { children: string }) => (
  <span
    ...
    style={{ color: "#414965", fontFamily: "'Gilroy-SemiBold', Helvetica, sans-serif" }}
  >
    {children}
  </span>
);
...
const AmountInput = ({
  ...
  >
    ...
    <input
      ...
      style={{ color: "#a8b9f4", fontFamily: "'Gilroy-SemiBold', Helvetica, sans-serif" }}
    />
  </div>
);
      ...
      <Card>
        <div className="flex items-center gap-4 p-5">
          <div
            ...
            style={{ background: "linear-gradient(135deg, #7631ee, #4a1a9e)", color: "white", fontFamily: "'Gilroy-Bold', Helvetica" }}
          >
          ...
          <div className="flex-1 min-w-0">
            {editing ? (
              <input
                ...
                style={{ borderColor: "#7631ee", color: "#c8d4f0", fontFamily: "'Gilroy-SemiBold', Helvetica" }}
                autoFocus
              />
            ) : (
              <p className="text-base" style={{ color: "#c8d4f0", fontFamily: "'Gilroy-SemiBold', Helvetica, sans-serif" }}>{name}</p>
            )}
            <p className="text-[12px] mt-0.5" style={{ color: "#414965", fontFamily: "'Gilroy-Medium', Helvetica, sans-serif" }}>{email}</p>
          </div>
          <button
          ...
          <SettingRow
            ...
            right={
              <button
                ...
                style={{ background: "#161b28", color: "#6c779d", fontFamily: "'Gilroy-SemiBold', Helvetica, sans-serif", border: "1px solid #1d2132" }}
              >
                Copy
              </button>
            }
