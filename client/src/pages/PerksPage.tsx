      ...
      <div className="flex flex-col gap-3 p-4">
        ...
        <div>
          <p
            ...
            style={{ color: "#c8d4f0", fontFamily: "'Gilroy-SemiBold', Helvetica, sans-serif" }}
          >
            {perk.title}
          </p>
          <p
  ...
  return (
    ...
    >
      <div className="flex flex-col">
        <span className="text-[11px]" style={{ color: "#414965", fontFamily: "'Gilroy-Medium', Helvetica, sans-serif" }}>Active perks</span>
        <span className="text-base" style={{ color: "#42bf23", fontFamily: "'Gilroy-SemiBold', Helvetica, sans-serif" }}>{activated} / {total}</span>
      </div>
      <div className="w-px h-8 bg-[#1d2132] flex-shrink-0" />
      <div className="flex flex-col">
        <span className="text-[11px]" style={{ color: "#414965", fontFamily: "'Gilroy-Medium', Helvetica, sans-serif" }}>Est. monthly value</span>
        <span className="text-base" style={{ color: "#c8d4f0", fontFamily: "'Gilroy-SemiBold', Helvetica, sans-serif" }}>$186</span>
      </div>
      <div className="w-px h-8 bg-[#1d2132] flex-shrink-0" />
      <div className="flex flex-col">
        <span className="text-[11px]" style={{ color: "#414965", fontFamily: "'Gilroy-Medium', Helvetica, sans-serif" }}>Partners</span>
        <span className="text-base" style={{ color: "#c8d4f0", fontFamily: "'Gilroy-SemiBold', Helvetica, sans-serif" }}>12</span>
      </div>
      <div className="flex-1" />
      {/* New tag */}
      <span
        className="px-2.5 py-1 rounded-full text-[11px]"
        style={{ background: "rgba(118,49,238,0.15)", color: "#9d5cf5", fontFamily: "'Gilroy-SemiBold', Helvetica, sans-serif", border: "1px solid rgba(118,49,238,0.25)" }}
      >
        3 new this month
      </span>
    </div>
    ...
    <div className="flex flex-col h-full bg-[#11141b] rounded-[16px] border border-solid border-[#1d2132] overflow-hidden">
      ...
      >
        ...
        >
          ...
          <span
            className="text-[11px]"
            style={{ color: "#9d5cf5", fontFamily: "'Gilroy-SemiBold', Helvetica, sans-serif" }}
          >
            Premium Cardholder
          </span>
        </div>
      ...
      <ScrollArea className="flex-1">
        ...
        <div className="px-5 pb-5">
          <p
            ...
            style={{ color: "#2a2f46", fontFamily: "'Gilroy-Medium', Helvetica, sans-serif" }}
          >
