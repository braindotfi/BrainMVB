...
export const AccountOverviewSection = ({ collapsed, onToggle }: Props): JSX.Element => {
    ...
    return (
      <div className="flex flex-col items-center gap-3 w-[52px] rounded-3xl border border-solid border-[#1d2131] bg-shared-colorsbaby-blue-5 flex-shrink-0 py-3">
        ...
        <button
          ...
          className="w-9 h-9 flex items-center justify-center bg-brain-v1baby-blue-15 rounded-xl hover:bg-brain-v1baby-blue-30 transition-colors"
        >
          <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
            <path d="M9 2L4 7L9 12" stroke="#8899bb" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        </button>
        {/* Wallet icon as visual hint */}
  ...
  return (
    <div className="flex flex-col gap-4 rounded-3xl border border-solid border-[#1d2131] bg-shared-colorsbaby-blue-5 w-[386px] flex-shrink-0">
      {/* Header bar */}
      <div className="flex mx-2 mt-2 h-12 items-center gap-2 p-2 bg-brain-v1baby-blue-15 rounded-2xl">
        <div className="flex items-center gap-2 flex-1">
          <img className="w-8 h-8" alt="Wallet icons" src="/figmaAssets/wallet-icons-1.svg" />
        ...
        <div className="inline-flex items-center gap-2 flex-shrink-0">
          <img className="w-5 h-5" alt="Icons" src="/figmaAssets/icons-15.svg" />
          {/* Collapse button */}
          <button
            onClick={onToggle}
            title="Collapse account panel"
            className="w-6 h-6 flex items-center justify-center rounded-lg hover:bg-brain-v1baby-blue-30 transition-colors"
          >
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
