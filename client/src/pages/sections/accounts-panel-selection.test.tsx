...
describe("adding money", () => {
  ...
  it("shows the wallet address and opens a generated QR overlay", () => {
    ...
    // Figma draws the code in Baby Blue 30 on the popup itself, not as a
    // black-on-white tile, so the fill is part of the claim.
    expect(code?.querySelector('path[fill="#414965"]')).not.toBeNull();
