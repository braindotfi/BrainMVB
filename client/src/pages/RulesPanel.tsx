...
function AutomationRow({ rule }: { rule: AutoRule }) {
  ...
  return (
    <div
      ...
      className="flex gap-[12px] items-center px-[16px] py-[6px] relative shrink-0 w-full bg-brain-v1highlight-dropdown-bg transition-colors border-b border-solid border-brain-v1stroke-2 last:border-b-0 hover:bg-brain-v1baby-blue-5 cursor-pointer"
    >
      <button
        type="button"
        onClick={open}
