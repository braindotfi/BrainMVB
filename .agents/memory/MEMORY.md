...
- [Policy clause scope](policy-scope-divergence.md) — a clause naming no category binds EVERY category in the gate; unknown scope = fail closed; the coverage-describer may read it the other way.
